                            ...
                            <View style={styles.container1}>
                                <View style={{flexDirection: 'column',marginVertical:5,marginHorizontal:5}}>
                                    ...
                                    <View>
                                        ...
                                        style={{borderColor: '#67bae3',color:"black",borderWidth: 2,width: 400,height: 35}}
                                    ...
                                    <View>
                                        ...
                                        placeholderTextColor="white"
                                        placeholder="Enter here"
                                        style={{borderColor: '#67bae3',color:"black",borderWidth: 2,width: 400,height: 35}}                                        value={this.state.contactNo}
