  ...
  componentDidMount() {
    ...
    firebase
      ...
      .on('value', (snapshot) => {
        ...
        firebase
          .database()
          .ref('student/' + currentUser[0].key + '/cv')
          .on('value', (snapshot) => {
            console.log('snapshot.val()', snapshot.val());
            const getValue = snapshot.val();
            ...
            <View style={styles.container1}>
              <View style={{flexDirection: 'column', marginHorizontal: 5}}>
                {/* <View style={{paddingVertical:5}}>
                                    ...
                                    <Text
                                        style={{borderColor: '#67bae3',color:"black",borderWidth: 2,width: wp('95%'),height: 35,paddingVertical:7,marginHorizontal:5,paddingHorizontal:10}}
                                    >
                                    {this.state.uid } 
                                    </Text>
                ...
                <View style={{paddingVertical: 7}}>
                  ...
                  <Text
                    style={{
                      borderColor: '#67bae3',
                      backgroundColor: this.state.TextInputDisableStatus
                        ? null
                        : '#C0C0C0',
                      color: 'black',
                      borderWidth: 2,
                ...
                <View>
                  ...
                  <TextInput
                    ...
                    placeholder={this.state.cvDescription}
                    style={{
                      borderColor: '#67bae3',
                      backgroundColor: this.state.TextInputDisableStatus
                        ? null
