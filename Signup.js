            ...
            style={styles.image}>
                {
                        ...
                        <KeyboardAwareScrollView >
                            <View style={{flexDirection:'row',borderWidth:1}}>
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <Image style={{marginVertical:5, width:40, height:40,marginHorizontal:5}}
                                            source={require('./back-button-icon-png-25.jpg')} />   
                                </TouchableOpacity>

                                    <View style={styles.container}>
                                        <Text style={styles.textHeader}> Student Registration </Text>
                                    </View>
                            ...
                            <View style={styles.container1}>
                                ...
                                <View>
                                    ...
                                    <View style={{marginVertical:5,marginHorizontal:5}}>
                                        ...
                                        <TouchableOpacity
                                        style={styles.button}
                                        onPress = {() => this.signup(this.state.name,this.state.email,this.state.password,this.state.address,this.state.contactNo)}
                                        >
                    ...
                    :
                        ...
                        <KeyboardAwareScrollView>
                            ...
                            <View style={styles.container1}>
                                <View style={{flexDirection: 'column',marginVertical:5,marginHorizontal:5}}>
                                    ...
                                    <View>
                                        ...
                                        placeholderTextColor="black "
                                        placeholder="Enter here"
                                        style={{borderColor: '#67bae3',color:"black",borderWidth: 2,width: 400,height: 35,paddingVertical:7}}                                        value={this.state.contactNo}
                                        onChangeText={(contactNo) => this.setState({contactNo: contactNo})}
                                        /> 
                                    ...
                                    <View style={{marginVertical:55}}>
                                        ...
                                        <TouchableOpacity
                                        style={styles.button}
                                        onPress = {() => this.csignup(this.state.name,this.state.email,this.state.password,this.state.address,this.state.contactNo)}
                                        >
                                            <Text style={styles.buttonText}>
                                            Registration
                                            </Text>
